...
TIP: To see these same tags in the AWS console, you can open the **AWS console** in your lab environment by clicking on the **Cloud (AWS)** tab, log in, and navigate to the EC2 service to inspect the instances.
