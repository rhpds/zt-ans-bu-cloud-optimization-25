...
+
Scroll to the bottom and click the **Create Survey Question** button.
...
+
Click the **Launch Template** button. This time, a survey will prompt you for input. Enter the following text into the text area to find only the instance named `rhel1`:
+
[source,text]
----
"tag:Name": "rhel1"
